#
# AVAPS RevC FPGA pin assignments
# Derived from adrv9631z7035/common/ccbob_constr.xdc.
# The original assignments are retained but commented out.
...
## My IO
#set_property  -dict {PACKAGE_PIN  AF14 IOSTANDARD LVCMOS25 PULLTYPE PULLUP} [get_ports iic_carrier_scl]           ; ## IO_L5P_T0_13                 U1,AF24,SCL,JX2,17,I2C_SCL,P2,14,P2,4,U1,Y16,IO_L23_12_JX2_P,JX2,97,LED_GPIO_3,P2,4
#set_property  -dict {PACKAGE_PIN  AF15 IOSTANDARD LVCMOS25 PULLTYPE PULLUP} [get_ports iic_carrier_sda]           ; ## IO_L5N_T0_13                 U1,AF25,SDA,JX2,19,I2C_SDA,P2,16,P2,15,U1,AB24,IO_L06_13_JX2_N,JX2,20,IO_L06_13_JX2_N,P2,15
# Onboard I2C
set_property  -dict {PACKAGE_PIN  AF14    IOSTANDARD  LVCMOS33} [get_ports  iic_carrier_scl]    ; ## U1,AF14,IO_L16_12_JX3_N,JX3,100,IO_L16_12_JX3_N,P13,5
set_property  -dict {PACKAGE_PIN  AF15    IOSTANDARD  LVCMOS33} [get_ports  iic_carrier_sda]    ; ## U1,AF15,IO_L16_12_JX3_P,JX3,98,IO_L16_12_JX3_P,P13,7

# Ublox
set_property  -dict {PACKAGE_PIN  AD14    IOSTANDARD  LVCMOS33} [get_ports  uart_gps_rx]   ; ## U1,AD14,IO_L13_MRCC_12_JX3_N,JX3,93,IO_L13_MRCC_12_JX3_N,P13,10
set_property  -dict {PACKAGE_PIN  AC14    IOSTANDARD  LVCMOS33} [get_ports  uart_gps_tx]   ; ## U1,AC14,IO_L13_MRCC_12_JX3_P,JX3,91,IO_L13_MRCC_12_JX3_P,P13,12
set_property  -dict {PACKAGE_PIN  AD11    IOSTANDARD  LVCMOS33} [get_ports  uart_gps_pps]   ; ## U1,AD11,IO_L11_SRCC_12_JX3_N,JX3,87,IO_L11_SRCC_12_JX3_N,P13,14

# Sonde Umbilical
set_property  -dict {PACKAGE_PIN  AD15    IOSTANDARD  LVCMOS33} [get_ports  uart_sonde_rx]   ; ## U1,AD15,IO_L15_12_JX3_N,JX3,99,IO_L15_12_JX3_N,P13,6
set_property  -dict {PACKAGE_PIN  AD16    IOSTANDARD  LVCMOS33} [get_ports  uart_sonde_tx]   ; ## U1,AD16,IO_L15_12_JX3_P,JX3,97,IO_L15_12_JX3_P,P13,8

# Pressure Sensor
set_property  -dict {PACKAGE_PIN  AF13    IOSTANDARD  LVCMOS33} [get_ports  rs232_rx]    ; ## U1,AF13,IO_L10_12_JX3_N,JX3,82,IO_L10_12_JX3_N,P13,19
set_property  -dict {PACKAGE_PIN  AE13    IOSTANDARD  LVCMOS33} [get_ports  rs232_tx]    ; ## U1,AE13,IO_L10_12_JX3_P,JX3,80,IO_L10_12_JX3_P,P13,21


# Launcher
set_property  -dict {PACKAGE_PIN  AD13    IOSTANDARD  LVCMOS33} [get_ports  gpio_launcher_in[0]]    ; ## U1,AD13,IO_L12_MRCC_12_JX3_N,JX3,88,IO_L12_MRCC_12_JX3_N,P13,13
set_property  -dict {PACKAGE_PIN  AC13    IOSTANDARD  LVCMOS33} [get_ports  gpio_launcher_in[1]]    ; ## U1,AC13,IO_L12_MRCC_12_JX3_P,JX3,86,IO_L12_MRCC_12_JX3_P,P13,15
set_property  -dict {PACKAGE_PIN  AB14    IOSTANDARD  LVCMOS33} [get_ports  gpio_launcher_out]    ; ## U1,AB14,IO_L14_SRCC_12_JX3_N,JX3,94,IO_L14_SRCC_12_JX3_N,P13,9

# USB Reset
set_property  -dict {PACKAGE_PIN  Y12     IOSTANDARD  LVCMOS33} [get_ports  gpio_usb]   ; ## U1,Y12,IO_L01_12_JX3_N,JX3,20,IO_L01_12_JX3_P,P13,36
...
#set_property  -dict {PACKAGE_PIN  J11     IOSTANDARD  LVCMOS18} [get_ports  gp_out[46]]   ; ## U#set_property  -dict {PACKAGE_PIN  AF13    IOSTANDARD  LVCMOS25} [get_ports  gp_in[70]]    ; ## U1,AF13,IO_L10_12_JX3_N,JX3,82,IO_L10_12_JX3_N,P13,19
...
#1,J11,IO_L01_34_JX4_P,JX4,19,IO_L01_34_JX4_P,P6,2
